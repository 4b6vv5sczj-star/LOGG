...
app.get('/',(_,res)=>res.json({ok:true,service:'LOGG Speech',version:'0.3.1'})); app.get('/health',(_,res)=>res.json({ok:true,service:'LOGG Speech',model:'chirp_3',region:process.env.GOOGLE_SPEECH_REGION||'eu',version:'0.3.1'}));
