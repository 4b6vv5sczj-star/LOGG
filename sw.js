const CACHE='logg-v0.10.4';
const FALLBACK=['./index.html','./styles.css?v=0.10.3','./app.js?v=0.10.3','./config.js?v=0.10.3','./home-sailing-yacht.png?v=0.10.3','./core/module-registry.js?v=0.10.3','./modules/meetings/module.js?v=0.10.3','./modules/notes/module.js?v=0.10.3'];
