const CACHE='logg-v0.9.0';
const FALLBACK=['./index.html','./styles.css?v=0.9.0','./app.js?v=0.9.0','./config.js?v=0.9.0','./home-sailing-yacht.png?v=0.9.0','./core/module-registry.js?v=0.9.0','./modules/meetings/module.js?v=0.9.0','./modules/notes/module.js?v=0.9.0'];
