const CACHE='logg-v0.4.0-20260921';
const CORE=['./','./index.html','./styles.css?v=0.4.0','./app.js?v=0.4.0','./config.js?v=0.4.0','./manifest.webmanifest?v=0.4.0','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
