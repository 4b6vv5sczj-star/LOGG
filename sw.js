const CACHE='logg-v0.3.1-20260921';
const CORE=['./','./index.html','./styles.css?v=0.3.1','./app.js?v=0.3.1','./config.js?v=0.3.1','./manifest.webmanifest?v=0.3.1','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
